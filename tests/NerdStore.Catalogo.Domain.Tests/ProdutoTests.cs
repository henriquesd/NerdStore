...
namespace NerdStore.Catalogo.Domain.Tests
{
    public class ProdutoTests
    {
        ...
        public void Produto_Validar_ValidacoesDevemRetornarExceptions()
        {
            ...
            // o certo seria criar um teste de unidade para testar as Dimensoes, se ele está validando todos os parâmetros;
            // o código aqui é só exemplo para mostrar a importância de validar;
            ex = Assert.Throws<DomainException>(() =>
